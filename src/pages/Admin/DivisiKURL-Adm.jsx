...
const DivisiKURL_Adm = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get('http://localhost:5001/api/divisi-kurl-adm');
  ...
  return (
    <div>
      ...
      {menuOpen && (
        <div className="md:hidden fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-75 z-50">
          <div className="flex flex-col items-center pt-10">
            <Link to="/DivisiKURL-Adm" onClick={closeMenu} className="text-white text-2xl mb-6">≡</Link>
      ...
      <div className="p-6">
        <h1 className="text-2xl font-bold mb-6 text-center">Data Pegawai Divisi Keuangan, Umum, Rumah Tangga & Logistik</h1>
