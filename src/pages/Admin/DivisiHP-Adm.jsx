...
const DivisiHP_Adm = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:5000/api/divisi-hp-adm');
  ...
  const handleCommentSubmit = async () => {
    try {
      ...
      await axios.post('http://localhost:5000/api/tambah-komentar-divisi-hp', {
    ...
    <div>
      ...
      <div className="flex flex-col min-h-screen p-6">
        <h1 className="text-2xl font-bold mb-6 text-center">
          Data Pegawai Divisi Hukum dan Pengawasan
        </h1>
                  ...
                  <div className="relative bg-white rounded-md shadow-lg p-6 w-11/12 max-w-lg">
                    ...
                    <div className="text-center">
                      <img
                        ...
                        alt={`Foto ${selectedUser.nama_div_hp}`}
                        className="w-32 h-32 rounded-full mx-auto mb-4"
                      />
                      <h2 className="text-xl font-semibold mb-2">
                        {selectedUser.nama_div_hp}
                      </h2>
