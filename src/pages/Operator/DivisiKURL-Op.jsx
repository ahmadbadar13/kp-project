...
const DivisiKURL_Op = () => {
  ...
  const handleSubmitNewUser = async (e) => {
    ...
    const formData = {
        ...
        nip_kurl: selectedDivision.nip_div,
  ...
  return (
    <div>
      ...
      <div className="flex flex-col min-h-screen p-6">
        <h1 className="text-2xl font-bold mb-6 text-center">Divisi Keuangan, Umum, Rumah Tangga, dan Logistik</h1>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                  <div className="relative bg-white rounded-md shadow-lg p-6 w-11/12 max-w-lg">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-lg font-medium">NIP: {selectedUser.nip_kurl}</p>
