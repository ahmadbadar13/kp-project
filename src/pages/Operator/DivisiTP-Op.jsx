...
const DivisiTP_Op = () => {
  ...
  const handleSubmitNewUser = async (e) => {
    ...
    const formData = {
        nama_div_tp: selectedDivision.nama_div,
        foto_div_tp: selectedDivision.foto_div,
        tanggal_lahir: selectedDivision.tanggal_lahir,
        email: selectedDivision.email,
        komentar_div_tp: selectedDivision.komentar_div_tp
    };
  ...
  const handleSubmitEditUser = async (e) => {
    ...
    formData.append('komentar_div_tp', editingUser.komentar_div_tp);
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:5000/api/divisi-tp-op/${editingUser.id}`,
        formData,
        {
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                  <div className="relative bg-white rounded-md shadow-lg p-6 w-11/12 max-w-lg">
                    ...
                    <div className="text-center">
                      <img
                        src={`http://localhost:5000${selectedUser.foto_div_tp}`}
                        alt={selectedUser.nama_div_tp}
                        className="w-32 h-32 rounded-full mx-auto mb-4"
                      />
                      <h2 className="text-xl font-semibold mb-2">{selectedUser.nama_div_tp}</h2>
