...
const DivisiPDI_Op = () => {
  ...
  const handleSubmitNewUser = async (e) => {
    ...
    const formData = {
        nama_div_pdi: selectedDivision.nama_div,
        foto_div_pdi: selectedDivision.foto_div,
        tanggal_lahir: selectedDivision.tanggal_lahir,
        email: selectedDivision.email,
        komentar_div_pdi: selectedDivision.komentar_div_pdi
    };
  ...
  const handleEditUser = (user) => {
    ...
    setEditingUser({
      ...
      email: user.email,
      komentar_div_pdi: user.komentar_div_pdi
    });
  };
  ...
  const handleSubmitEditUser = async (e) => {
    ...
    formData.append('komentar_div_pdi', editingUser.komentar_div_pdi);
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:5000/api/divisi-pdi-op/${editingUser.id}`,
        formData,
        {
                  ...
                  <div className="relative bg-white rounded-md shadow-lg p-6 w-11/12 max-w-lg">
                    ...
                    <div className="text-center">
                      <img
                        ...
                        alt={selectedUser.nama_div_pdi}
                        className="w-32 h-32 rounded-full mx-auto mb-4"
                      />
                      <h2 className="text-xl font-semibold mb-2">{selectedUser.nama_div_pdi}</h2>
